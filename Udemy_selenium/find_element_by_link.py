...
test=driver.find_element(By.CSS_SELECTOR,'a[href*="supersqa.com/cart"]')
# Tes=driver.find_element(By.LINK_TEXT,'Cart')
print(test.text)

test_p=driver.find_element(By.PARTIAL_LINK_TEXT,'cart')
print(test_p)
