...
url ='file:///D:/Udemy/SQA/Project_Python/my_code/python-selenium-course-material/python_selenium_course_material/SELENIUM_SECTION/Radios/radios_example.html'
driver.get(url)
